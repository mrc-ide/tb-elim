...
subplot(1,2,1);
yline(1.05,'k--');
legend(lg, 'Baseline','TPT, recent migrants','+ Case-finding, active TB','+ TPT, new migrants (hypothetical)', 'Elimination target','location','SouthWest');
